...
- **How do I add a new command?** See [DEVELOPER_GUIDE.md](docs/agent/DEVELOPER_GUIDE.md) (for LLMs) or copy an existing command.
- **Where's the architecture?** See [ARCHITECTURE.md](docs/agent/ARCHITECTURE.md).
