...
- **project_rules.md** — Project specification, requirements, security rules
- **.github/copilot-instructions.md** — AI coding guidelines and standards
...
| Project spec | `project_rules.md` | LLMs | Requirements list |
| AI coding rules | `.github/copilot-instructions.md` | LLMs | Prose + rules |
...
1. **project_rules.md** § "Header Standard" → Exact format
...
4. **.github/copilot-instructions.md** — Overall rules and patterns
